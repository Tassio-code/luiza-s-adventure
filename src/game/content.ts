...
export const LEVELS: LevelDef[] = [
  ...
  },
  {
    ...
    region: "Deserto",
    description: "Templos meio engolidos pelas dunas. Esqueletos despertam quando a areia se move.",
    weapon: "shotgun",
    enemy: "skeleton",
    enemyCount: 50,
    waveSize: 12,
