...
export const STAGE_TRACKS: TrackConfig[] = [
  {
    ...
    src: null,
    duration: 135,
    plan: { duration: 135, rampStart: 0.74, spawnStop: 0.9, baseAlive: 7, maxAlive: 20, maxBurst: 3, minInterval: 0.4 },
  },
  {
    id: "stage-cidade",
    src: null,
    duration: 145,
    plan: { duration: 145, rampStart: 0.76, spawnStop: 0.91, baseAlive: 8, maxAlive: 23, maxBurst: 4, minInterval: 0.34 },
  },
  {
    id: "stage-neve",
    src: null,
    duration: 155,
    plan: { duration: 155, rampStart: 0.78, spawnStop: 0.92, baseAlive: 8, maxAlive: 25, maxBurst: 4, minInterval: 0.32 },
  },
  {
    id: "stage-deserto",
    src: null,
    duration: 160,
    plan: { duration: 160, rampStart: 0.8, spawnStop: 0.93, baseAlive: 9, maxAlive: 27, maxBurst: 5, minInterval: 0.3 },
  },
  {
    id: "stage-castelo",
    src: null,
    duration: 175,
    plan: { duration: 175, rampStart: 0.82, spawnStop: 0.94, baseAlive: 10, maxAlive: 30, maxBurst: 5, minInterval: 0.26 },
  },
];
