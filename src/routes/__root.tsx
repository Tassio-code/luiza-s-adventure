...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "apple-mobile-web-app-title", content: "5 Fragmentos" },
    ...
    links: [
      ...
      { rel: "icon", href: publicAsset("favicon.png"), type: "image/png" },
      { rel: "manifest", href: publicAsset("manifest.webmanifest") },
      { rel: "apple-touch-icon", href: publicAsset("icons/icon-192.png") },
